...
A confidence interval estimates a range of plausible values of a parameter of interest, such as  regression parameters or the mean of a random variable; a prediction interval tries to estimate a range of plausible variables for a single out of sample point e.g. the a new $Y_i$. A prediction interval for $\hat{Y}_i$ would be
